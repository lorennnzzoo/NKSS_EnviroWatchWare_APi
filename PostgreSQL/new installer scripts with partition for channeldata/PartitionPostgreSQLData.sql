...
-- Started on 2025-02-18 16:53:53
...
--
-- TOC entry 4945 (class 0 OID 36003)
-- Dependencies: 218
...
1	RS485INTEGER	01 03 00 00 00 08 44 0C	COM3	9600	NONE	8	1	null	\N	Falcon	A2D	t	C
\.


--
-- TOC entry 4950 (class 0 OID 36030)
-- Dependencies: 223
...
--
-- TOC entry 4952 (class 0 OID 36035)
-- Dependencies: 225
...
--
-- TOC entry 4958 (class 0 OID 36061)
-- Dependencies: 231
...
--
-- TOC entry 4959 (class 0 OID 36065)
-- Dependencies: 232
...
--
-- TOC entry 4962 (class 0 OID 36075)
-- Dependencies: 235
...
--
-- TOC entry 4963 (class 0 OID 36079)
-- Dependencies: 236
...
--
-- TOC entry 4947 (class 0 OID 36010)
-- Dependencies: 220
...
--
-- TOC entry 4948 (class 0 OID 36025)
-- Dependencies: 221
...
--
-- TOC entry 4971 (class 0 OID 36263)
-- Dependencies: 245
-- Data for Name: ChannelData_2025_02; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ChannelData_2025_02" ("Id", "ChannelId", "ChannelValue", "ChannelDataLogTime", "Active", "Processed") FROM stdin;
\.


--
-- TOC entry 4954 (class 0 OID 36043)
-- Dependencies: 227
...
--
-- TOC entry 4955 (class 0 OID 36049)
-- Dependencies: 228
...
--
-- TOC entry 4957 (class 0 OID 36055)
-- Dependencies: 230
...
--
-- TOC entry 4961 (class 0 OID 36070)
-- Dependencies: 234
...
--
-- TOC entry 4965 (class 0 OID 36087)
-- Dependencies: 238
...
SELECT pg_catalog.setval('public."ChannelDataFeed_Id_seq"', 2, true);
...
SELECT pg_catalog.setval('public."ChannelData_Id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Oxide_Id_seq"', 1, true);
...
-- Completed on 2025-02-18 16:53:53
